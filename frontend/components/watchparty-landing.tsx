    ...
    <main className="min-h-screen overflow-hidden bg-[#f2efe7] text-[#163a5c] selection:bg-[#d77991] selection:text-[#f8f5ed]">
      <section className="relative isolate flex min-h-[100svh] flex-col overflow-hidden bg-[#7e9fc2] md:block md:min-h-0">
        ...
        <header className="relative z-10 mx-auto flex w-full max-w-[1440px] items-center justify-between gap-3 px-5 py-5 sm:px-10 sm:py-7 lg:px-16">
          <a href="/" className="flex min-w-0 items-center gap-2 text-[11px] font-bold tracking-[.08em] text-[#102c4a] sm:gap-3 sm:text-sm">
          ...
          <button
            ...
            className="cursor-pointer rounded-full border border-[#102c4a]/60 bg-[#f6fbfc]/35 shrink-0 px-4 py-2 text-[10px] font-bold tracking-[.16em] text-[#102c4a] shadow-sm backdrop-blur-sm transition-colors hover:bg-[#102c4a] hover:text-[#f8f5ed] uppercase"
          >
            Get Started
          </button>
        </header>
        ...
        <div className="relative z-10 mx-auto flex flex-1 max-w-[1440px] flex-col justify-center px-5 pb-16 pt-2 sm:px-10 sm:pb-16 sm:pt-20 md:flex-none lg:px-16 lg:pb-20 lg:pt-24">
          <div className="max-w-[640px]">
            ...
            <button
              onClick={() => openAuthModal("register")}
              className="cursor-pointer mt-5 inline-flex items-center gap-3 rounded-full bg-[#172d4d] px-5 py-2.5 text-[10px] font-semibold tracking-[.15em] text-[#f8f5ed] transition hover:bg-[#a83f68] uppercase sm:mt-8 sm:gap-4 sm:px-6 sm:py-3.5 sm:text-[11px] shadow-md"
            >
              Find your people <ArrowUpRight size={13} />
            </button>
          </div>
        </div>
