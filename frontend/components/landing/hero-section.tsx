...
function BlurWord({ word, trigger }: { word: string; trigger: number }) {
  ...
  const gradientColors = ["#9edcff", "#4bbdff", "#5ce1db", "#b1f5ff", "#9edcff"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          playsInline
          aria-hidden="true"
          className="w-full h-full object-cover object-center opacity-75 saturate-[0.8] hue-rotate-[55deg]"
        >
          <source src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bg-hero-0BnFGdr81Ifnj3WbBZoNt1KE4D5DMT.mp4" type="video/mp4" />
        </video>
        {/* Subtle overlay to ensure text readability on the left */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#06152b]/90 via-[#06152b]/45 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-[#06152b]/80" />
      </div>
